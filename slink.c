...
static unsigned int get_number(char *);
 ...
 */
#define	DIRSEP	'/'		/* directory-filename separator (Linux) */

static char *library = "./lib09", *index_file = "EXTINDEX.LIB",
 ...
 */
static FILE *open_lib(char *fname)
{
	char *ptr, *ptr1, c;
	FILE *fp;
 ...
 */
static unsigned int get_number(char *ptr)
{
